...
class VaccineTest {
    ...
    void setUp() {
        ...
        registrated.add(new Person("Kis Elemér", 45, ChronicDisease.NO, Pregnancy.NO));
    ...
    void testFirstVaccine() {
        ...
        Assertions.assertEquals("Kis Elemér", vaccine.getVaccinationList().get(6).getName());
    ...
    void testSecondVaccine() {
        ...
        Assertions.assertEquals("Kis Elemér", vaccine.getVaccinationList().get(0).getName());
