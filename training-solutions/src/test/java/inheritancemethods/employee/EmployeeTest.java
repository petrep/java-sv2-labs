...
class EmployeeTest {
    ...
    void testCreateEmployee() {
        //Given
        Employee employee = new Employee("John Doe", "1117 Budapest, Budafoki út 56.", 400_000);
        //Then
        assertEquals("John Doe", employee.getName());
        assertEquals("1117 Budapest, Budafoki út 56.", employee.getAddress());
        assertEquals(400_000.0, employee.getSalary());
    }
    ...
    void testRaiseSalary() {
        ...
        //Then
        assertEquals(440_000.0, employee.getSalary());
    }
}
