...
class MonumentTest {
	...
	@Test
	void testCreate() {
		Monument monument = new Monument("Plébániatemplom", "5342 Pécs, Fő utca 3.",
				  LocalDate.of(2015, 2, 4), "MRN-4326-T");

		assertEquals("Plébániatemplom", monument.getName());
		assertEquals("5342 Pécs, Fő utca 3.", monument.getAddress());
	...
	void testCreateWithNullName() {
		Exception ex = assertThrows(IllegalArgumentException.class,
				  () -> new Monument(null, "5342 Pécs, Fő utca 3.",
							 LocalDate.of(2015, 2, 4), "MRN-4326-T"));
	...
	void testCreateWithEmptyName() {
		Exception ex = assertThrows(IllegalArgumentException.class,
				  () -> new Monument("   ", "5342 Pécs, Fő utca 3.",
							 LocalDate.of(2015, 2, 4), "MRN-4326-T"));
		assertEquals("Name, address or registry number cannot be empty!", ex.getMessage());
	}
	...
	void testCreateWithNullRegistryNumber() {
		Exception ex = assertThrows(IllegalArgumentException.class,
				  () -> new Monument("Plébániatemplom", "5342 Pécs, Fő utca 3.",
