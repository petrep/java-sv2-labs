...
class BookSearchTest {
    ...
    void testFindBookByAuthorTitle() {
        ...
        //When
        Book book = search.findBookByAuthorTitle("Markwart Zsófia", "Bambi");
        //Then
        assertEquals(1037, book.getId());
        assertEquals("Markwart Zsófia", book.getAuthor());
        assertEquals("Bambi", book.getTitle());
        assertEquals("1037 Markwart Zsófia Bambi", book.toString());
    }
}
