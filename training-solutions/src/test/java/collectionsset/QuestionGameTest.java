...
class QuestionGameTest {
    ...
    void init() {
        ...
        rightAnswers.add(new RightAnswer("Juhász József"));
    ...
    void testDrawWinnersNotEnoughRightAnswers() {
        questionGame = new QuestionGame(new ArrayList<>(Arrays.asList(new RightAnswer("Juhász József"), new RightAnswer("Nagy Béla"))));
