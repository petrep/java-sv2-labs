...
public class WordsTest {
    ...
    public void testGetFirstWordWithA() {
        Path path = Paths.get("src/test/java/introexceptionreadfiletestjunit5/words.txt");
    ...
    public void testGetFirstWordWithANoSuchWord() {
        Path path = Paths.get("src/test/java/introexceptionreadfiletestjunit5/anotherwords.txt");
        String firstWordWithA = words.getFirstWordWithA(path);
