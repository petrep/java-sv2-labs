...
class HomeSchoolingTest {
    ...
    void init() {
        ...
        schooling.addNewLesson(new OnlineLesson("Juhász József", "matematika", LocalDateTime.of(2021, 12, 14, 8, 0)));
        schooling.addNewLesson(new OnlineLesson("Nagy Béla", "biológia", LocalDateTime.of(2021, 12, 15, 8, 0)));
        schooling.addNewLesson(new OnlineLesson("Juhász József", "matematika", LocalDateTime.of(2021, 12, 16, 8, 0)));
    }
    ...
    void testRemoveLesson() {
        ...
        assertEquals("Juhász József", schooling.getLessons().get(0).getTeacherName());
        assertEquals("Juhász József", schooling.getLessons().get(1).getTeacherName());
    }
}