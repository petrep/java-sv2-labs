...
class TransactionCounterTest {
    ...
    void testCountEntryLessThan() {
        List<Transaction> transactions = Arrays.asList(
                new Transaction("123456", TransactionType.CREDIT, 1000),
                new Transaction("123456", TransactionType.CREDIT, 2000),
                new Transaction("123456", TransactionType.CREDIT, 3000),
                new Transaction("123456", TransactionType.CREDIT, 4000)
        );
