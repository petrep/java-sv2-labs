...
public class WebShopTest {
    ...
    void init() {
        ...
        webShop.addProducts(new Product("Monitor", 1, LocalDateTime.of(2017, 1, 1, 10, 12)));
        webShop.addProducts(new Product("Phone", 5, LocalDateTime.of(2015, 1, 1, 10, 12)));
    }

    @Test
    void testOrderByName() {
        assertEquals(Arrays.asList("Earphone", "Monitor", "Phone", "SSD", "Winchester"),
                names(webShop.getProductsOrderByName()));
    }

    @Test
    void testOrderByPrice() {
        assertEquals(Arrays.asList("Monitor", "Phone", "SSD", "Winchester", "Earphone"),
                names(webShop.getProductsOrderByPrice()));
    }

    @Test
    void testOrderByDate() {
        assertEquals(Arrays.asList("Winchester", "SSD", "Phone", "Earphone", "Monitor"),
