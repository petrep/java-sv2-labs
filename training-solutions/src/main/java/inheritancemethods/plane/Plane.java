...
public class Plane {
    ...
    public static void main(String[] args) {
        Passenger passenger = new Passenger("John Doe", 77000);
        System.out.println(passenger.getName());
        System.out.println(passenger.getPriceOfPlaneTicket());

        PriorityPassenger priorityPassenger = new PriorityPassenger("Jack Doe", 100000, 30);
        ...
        FirstClassPassenger firstClassPassenger = new FirstClassPassenger("James Doe", 100000, 30);
