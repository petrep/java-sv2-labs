...
public class Architect {
    ...
    public static void main(String[] args) {
        Plan firstPlan = new SketchPlan(155, "Családi ház");
        System.out.println(firstPlan.getPagesOfDocumentation());

        Plan secondPlan = new PermitPlan(155, "Családi ház", "Nagy Elemér", "1011, Árnyas u. 20");
        System.out.println(secondPlan.getPagesOfDocumentation());

        Plan thirdPlan = new ConstructionPlan(155, "Családi ház", "Nagy Elemér", "1011, Árnyas u. 20", 72);
        System.out.println(thirdPlan.getPagesOfDocumentation());

        SketchPlan firstSketchPlan = new SketchPlan(155, "Családi ház");
        System.out.println(firstSketchPlan.getTitle());
        System.out.println(firstSketchPlan.getPagesOfDocumentation());

        SketchPlan secondSketchPlan = new PermitPlan(155, "Családi ház", "Nagy Elemér", "1011, Árnyas u. 20");
        System.out.println(secondSketchPlan.getTitle());
        System.out.println(secondSketchPlan.getPagesOfDocumentation());

        SketchPlan thirdSketchPlan = new ConstructionPlan(155, "Családi ház", "Nagy Elemér", "1011, Árnyas u. 20", 72);
        System.out.println(thirdSketchPlan.getTitle());
        System.out.println(thirdSketchPlan.getPagesOfDocumentation());

        Header firstHeader = new PermitPlan(155, "Családi ház", "Nagy Elemér", "1011, Árnyas u. 20");
        System.out.println(firstHeader.getNameOfClient());
        System.out.println(firstHeader.getAddressOfBuilding());

        Header secondHeader = new ConstructionPlan(155, "Családi ház", "Nagy Elemér", "1011, Árnyas u. 20", 72);
        System.out.println(secondHeader.getNameOfClient());
        System.out.println(secondHeader.getAddressOfBuilding());

        PermitPlan firstPermitPlan = new PermitPlan(155, "Családi ház", "Nagy Elemér", "1011, Árnyas u. 20");
        ...
        PermitPlan secondPermitPlan = new ConstructionPlan(155, "Családi ház", "Nagy Elemér", "1011, Árnyas u. 20", 72);
        ...
        ConstructionPlan constructionPlan = new ConstructionPlan(155, "Családi ház", "Nagy Elemér", "1011, Árnyas u. 20", 72);
