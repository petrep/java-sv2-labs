...
public class Patient {
    ...
    public static void main(String[] args) {
        Patient firstPatient = new Patient("Edward First", "123456788", 1954);
        ...
        Patient secondPatient = new Patient("a", "123456788", 1954);
        ...
        Patient thirdPatient = new Patient("John Third", "111563333", 1954);
        ...
        Patient fourthPatient = new Patient("Charles Fourth", "123456788", 1777);
